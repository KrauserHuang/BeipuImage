...
import UIKit
protocol ShoppingCartTableViewControllerDelegate: AnyObject {
...
class ShoppingCartTableViewController: UITableViewController {
    ...
    weak var delegate: ShoppingCartTableViewControllerDelegate?
...
class ShoppingCartTableViewCell: UITableViewCell {
    ...
    @IBOutlet var quentyButtons: [UIButton]!
