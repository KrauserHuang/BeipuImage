...
//        let shopPredicate = NSPredicate(format: "SELF MATCHES %@", "^[0-9]{8}$")
//        guard predicate.evaluate(with: accountTextField.text) || shopPredicate.evaluate(with: accountTextField.text) else {
